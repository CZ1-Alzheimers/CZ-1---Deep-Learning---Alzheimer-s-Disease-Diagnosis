...
def check_accuracy(test_results_path):
    ...
    plot_confusion_matrix(cm, target_names, results_path, f"Test_Prediction_{get_data_name(test_results_path)}")
    # Print results
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            test_output_filename = f"Results/{data}/PCA - {pca_num}/Test_Prediction_{test_data}.csv"
